...
if __name__ == "__main__":
    ...
    with open(data_dir / "klifs_structures.csv", "w") as f:
    ...
    for batch_num in range(0, batch_count):
        ...
        with open(data_dir / "klifs_structures.csv", "a") as f:
            for idx, row in df[batch_start:batch_end].iterrows():
                ...
                try:
                    ...
                    with open(data_dir / "klifs_failures.csv", "a") as err:
